...
/**
 * Asistencia/Bienestar es PRODUCTOR (AttendanceRecorded, IncidentReported) y CONSUMIDOR de
 * StudentEnrolled (para su proyeccion local de estudiantes).
 */
@Configuration
public class RabbitMQConfig {
    ...
    public static final String Q_STUDENT = "q.attendance.student";
